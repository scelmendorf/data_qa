...
The [summarytools](https://htmlpreview.github.io/?https://github.com/dcomtois/summarytools/blob/master/doc/introduction.html) package introduced in the [Missing data](missing_data.qmd) module includes information on the number of complete duplicates (all values identical) in our dataset. We can also get this information from one line of code.
