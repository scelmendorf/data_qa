...
The [summarytools](https://htmlpreview.github.io/?https://github.com/dcomtois/summarytools/blob/master/doc/introduction.html) package introduced in [module 2](missing_data.qmd) includes information on the number most commonly encountered strings in non-numeric fields. If you have 10 or fewer categories, this can be a great way to quickly see what the most common categories are and if you have spelled them correctly.
...
We might also postulate that spaces are causing us problems more generally, or other characters. Would it be appropriate to remove all the spaces, tabes, newlines and carriage returns in the variety names? Learning a little about [regular expressions](https://r4ds.had.co.nz/strings.html#matching-patterns-with-regular-expressions) can help you here!
...
Last, you might curate a list that matches the misented name to the correct name, or use someone else's. For example, the [taxoncleanr](https://ediorg.github.io/taxonomyCleanr/articles/a_common_use_case.html) package can help simplify the world of pain that is aligning taxonomic names.
